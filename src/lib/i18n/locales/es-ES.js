...
export default {
  ...
  "detail.sync.desc":
    "Vuelve a traer las carátulas y los metadatos de este juego desde Steam. Si tienes una cuenta vinculada, también resincroniza sus logros.",
  "detail.sync.syncing": "Sincronizando…",
  "detail.sync.action": "Sincronizar logros",
  "detail.artSync.syncing": "Sincronizando…",
  "detail.artSync.action": "Sincronizar carátulas y metadatos",
  ...
  "art.toast.refreshed": "Carátulas reimportadas",
  "art.importing": "Copiando…",
  "art.pickGriddb": "🔎 SteamGridDB",

  // --- Fase 3: SteamGridDB (feature-imagenes.md) ---
  "griddb.modal.aria": "Elegir imagen de SteamGridDB",
  "griddb.modal.heading": "SteamGridDB — {slot} de {title}",
  "griddb.modal.noKey": "Agrega tu API key de SteamGridDB en Configuración → Cuentas para buscar carátulas.",
  "griddb.modal.resolving": "Buscando el juego en SteamGridDB…",
  "griddb.search.placeholder": "Nombre del juego…",
  "griddb.search.action": "Buscar",
  "griddb.search.searching": "Buscando…",
  "griddb.search.empty": "Sin resultados",
  "griddb.filter.nsfw": "Contenido para adultos",
  "griddb.filter.humor": "Humor / memes",
  "griddb.filter.epilepsy": "Riesgo de epilepsia",
  "griddb.filter.animated": "Imágenes animadas",
  "griddb.filter.toggle": "Filtros",
  "griddb.filter.styles": "Estilo",
  "griddb.filter.dimensions": "Resolución",
  "griddb.filter.mimes": "Formato",
  "griddb.style.alternate": "Alterno",
  "griddb.style.blurred": "Difuminado",
  "griddb.style.white_logo": "Logo blanco",
  "griddb.style.material": "Material",
  "griddb.style.no_logo": "Sin logo",
  "griddb.style.official": "Oficial",
  "griddb.style.white": "Blanco",
  "griddb.style.black": "Negro",
  "griddb.style.custom": "Personalizado",
  "griddb.mime.png": "PNG",
  "griddb.mime.jpeg": "JPEG",
  "griddb.mime.webp": "WEBP",
  "griddb.images.loading": "Cargando imágenes…",
  "griddb.images.empty": "Sin imágenes con estos filtros",
  "griddb.toast.imported": "Imagen importada desde SteamGridDB",
  "griddb.pager.prev": "‹ Anterior",
  "griddb.pager.next": "Siguiente ›",
  "griddb.pager.page": "Página {page} de {total}",
  "griddb.account.title": "SteamGridDB",
  "griddb.account.desc":
    "Trae carátulas, heroes y logos elegidos a mano al personalizar el arte de un juego (botón «SteamGridDB» junto a cada imagen).",
  "griddb.account.keyPlaceholder": "API key de SteamGridDB",
  "griddb.account.linkAction": "Guardar",
  "griddb.account.linking": "Validando…",
  "griddb.account.linked": "Key guardada",
  "griddb.account.unlink": "Quitar",
  "griddb.account.getKey": "Generar una API key",
  "griddb.toast.keyLinked": "API key de SteamGridDB guardada",
  "griddb.toast.keyCleared": "API key de SteamGridDB quitada",
  ...
  "qam.system.noNetworks": "No se han encontrado redes",
  ...
  "updates.channel.desc":
    "El canal beta trae las novedades antes, con más riesgo de fallos. Al cambiar de canal, la actualización solo aparece cuando ese canal publique una versión mayor a la instalada.",
  "updates.channel.options.stable": "Estable",
  "updates.channel.options.beta": "Beta",
  "updates.channel.stableEmpty":
    "Aún no hay versiones estables publicadas: por ahora las novedades salen solo en el canal beta.",
  "updates.checkOnStart.title": "Buscar al iniciar",
  "updates.checkOnStart.desc":
    "Comprueba si hay una versión nueva cada vez que abres VELUM. La instalación siempre la confirmas tú.",
  ...
  "errors.art.invalid_kind": "Tipo de imagen no válido: {detail}",
  "errors.art.source_missing": "Ese archivo ya no existe",
  "errors.art.unsupported_ext": "Extensión de imagen no soportada: {detail}",
  "errors.art.too_large": "La imagen pesa más de lo permitido (máx. 32 MB)",
  "errors.art.import_failed": "No se pudo importar la imagen: {detail}",
  "errors.art.download_failed": "No se pudo descargar la imagen: {detail}",
  "errors.griddb.key_read_failed": "No se pudo leer la API key de SteamGridDB: {detail}",
  "errors.griddb.missing_key": "Escribe una API key",
  "errors.griddb.invalid_key": "API key de SteamGridDB inválida",
  "errors.griddb.key_validation_failed": "No se pudo validar la API key: {detail}",
  "errors.griddb.key_save_failed": "No se pudo guardar la API key de forma segura: {detail}",
  "errors.griddb.invalid_platform": "Plataforma no soportada: {detail}",
  "errors.griddb.http": "SteamGridDB devolvió un error: {detail}",
  "errors.griddb.invalid_kind": "Tipo de imagen no válido: {detail}",
  "errors.griddb.invalid_style": "Estilo no válido: {detail}",
  "errors.griddb.dimensions_not_supported": "Este tipo de imagen no admite filtrar por resolución",
  "errors.griddb.invalid_dimension": "Resolución no válida: {detail}",
  "errors.griddb.invalid_mime": "Formato no válido: {detail}",
  "errors.griddb.invalid_type": "Tipo no válido: {detail}",
  "errors.griddb.invalid_tag_value": "Valor de filtro no válido: {detail}",
  ...
  "errors.system.task_failed": "No se ha podido completar la operación del sistema: {detail}",
  "errors.system.unsupported": "Esta acción no está disponible en este sistema",
  "errors.system.shutdown_failed": "No se ha podido apagar el equipo: {detail}",
  "errors.system.audio.com_failed": "No se ha podido acceder al audio del sistema: {detail}",
  "errors.system.audio.device_not_found": "Ese dispositivo de audio ya no está disponible",
  "errors.system.audio.set_default_failed": "No se ha podido cambiar el dispositivo predeterminado",
  "errors.system.wifi.access_denied":
    "Windows no ha permitido buscar redes. Suele pasar si los permisos de ubicación están desactivados (Configuración → Privacidad → Ubicación) o si el servicio de Wi-Fi está deshabilitado.",
  ...
  "errors.system.wifi.scan_failed": "No se han podido buscar redes: {detail}",
  "errors.system.wifi.profile_failed": "No se ha podido guardar el perfil de la red: {detail}",
  "errors.system.wifi.connect_failed": "No se ha podido conectar a la red: {detail}",
  "errors.system.wifi.wrong_password": "Contraseña incorrecta",
  "errors.system.wifi.timeout": "La red no ha respondido a tiempo",
  "errors.system.radio.unavailable": "No se ha encontrado la radio de ese adaptador",
  "errors.system.radio.access_denied": "Windows no ha dado permiso para controlar la radio",
  "errors.system.radio.set_failed": "No se ha podido encender o apagar la radio: {detail}",
  "errors.system.bt.unavailable": "El Bluetooth no está disponible o está apagado",
  "errors.system.bt.scan_failed": "No se han podido buscar dispositivos: {detail}",
  "errors.system.bt.device_not_found": "Ese dispositivo ya no está disponible",
  "errors.system.bt.pair_failed": "No se ha podido emparejar el dispositivo: {detail}",
  "errors.system.bt.pair_rejected": "El dispositivo ha rechazado el emparejamiento",
  "errors.system.bt.pin_required": "Ese dispositivo pide un PIN: empareja esta vez desde Windows",
  "errors.system.bt.unpair_failed": "No se ha podido olvidar el dispositivo: {detail}",
  "errors.system.bt.connect_failed": "No se ha podido conectar el dispositivo: {detail}",
